...
void Outrun::drawQuad(RenderWindow &w, Color c, int x1, int y1, int w1, int x2, int y2, int w2){
	ConvexShape shape(4);
...
void Outrun::Line::project(int camX, int camY, int camZ){
	scale = camD / (z - camZ);
...
void Outrun::Line::drawSprite(RenderWindow& app) {
	Sprite s = sprite;
